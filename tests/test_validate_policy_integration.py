...
def _write_manifest(build_dir: Path, *, domains: dict) -> None:
    """
    ...
    manifest = {
        ...
        "builder": {"name": "course-engine", "version": "1.3.1", "python": "3.x"},
...
def test_policy_thresholds_change_validation_output(tmp_path: Path):
    """
    Expected v1.4 behaviour:
      - validation without --policy uses engine default thresholds (v1.3-compatible)
